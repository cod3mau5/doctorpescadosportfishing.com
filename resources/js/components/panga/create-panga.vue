                            ...
                            <div class="row">
                                ...
                                <div class="file-field">
                                    <div class="z-depth-1-half mb-4">
                                        ...
                                        alt="example placeholder" v-show="!panga.img_preview">

                                        <img :src="panga.img_preview" class="img-fluid"
                                        alt="example placeholder" v-show="panga.img_preview">
                                    </div>
                                    <div class="d-flex justify-content-center">
                                        <div class="btn btn-mdb-color btn-rounded" style="max-width:100%" :class="{ 'alert-red': alert.img_panga }">
                                            <span>Subir Imagen Principal de la Panga</span> <br>
                                            <input type="file" name="img" id="imgPanga" style="max-width:100%;overflow:hidden" v-on:change="previewFiles" @click="alert.img_panga = false">
                                        </div>
                                    </div>
                                </div>
                                </div>
    ...
    export default {
        ...
        mounted() {
                            ...
                            success: function(response) {
                                if (response.action == "success") {
                                    ...
                                    setTimeout(function() {
                                        ...
                                        expandFunction(event,'navbarSupportedContent44','navbarSon4')
                                        $.unblockUI();
                                    }, 2540);
                                } else {
                                    let unorderList='';
            ...
            $('#editCaptain').click((event) =>  {
                ...
                if (typeof files !== "undefined"){
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'update-captain-info/'+panga_id,
                        dataType: 'json',
                        contentType: false,
                        processData: false,
                        data: fd,
        ...
        methods:{
            ...
            updateBoatSpecs:function(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'edit-boat-specification/'+panga_id,
                        dataType: 'json',
                        data: data,
                        success: function(response) {
                            if (response.action == "success") {
