                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group" :class="{ 'alert-red': alert.charter_errors.description }">
                                    ...
                                    <button type="submit" class="btn btn-info float-right mt-2 py-2 px-4" style="font-size:18px;font-weight:bolder" id="submitCharter" v-show="!editing_panga">Subir Panga</button>
                                    <button type="submit" class="btn btn-edit float-right mt-2 py-2 px-4" style="font-size:18px;font-weight:bolder" id="editCharter" v-show="editing_panga">Editar Panga</button>
    ...
    export default {
        data: function(){
            return {
                ...
                rates:JSON.parse(this.$props.charter_rates),
                boatSpecs:{
                    ...
                    fd.append('_token', vm.$props.csrf_token);
                        ...
                        success: function(response) {
                            if (response.action == "success") {
                                ...
                                $.blockUI({
                                    message: '<p style="font-weight:bolder;font-size:3em;text-align:center;color:#ffffff;line-height:1;margin-bottom:.3rem">Panga <span style="color:#7400b8">' + response.charter_name + '</span> creada!<br> ahora puedes seguir editando más propiedades de la lancha<span style="color:#7400b8">...</span></p>',
                                    css: {
                                        width: '650px',
                                        border: 'none',
                                        padding: '15px',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.action == "success") {
                                ...
                                if(response.max_anglers){unorderList=unorderList+'<li>'+response.max_anglers+'</li>'}
                                if(response.feets){unorderList=unorderList+'<li>'+response.feets+'</li>'}
                                if(response.img){unorderList=unorderList+'<li>'+response.img+'</li>'}
