...
<div class="container-fluid px-0">
            ...
            <!-- charter_form -->
            <div class="row px-0">
                <form class="col-12 mb-4" method="POST" action="" enctype='multipart/form-data' id="charter-form">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group"  :class="{ 'alert-red': alert.charter_errors.name }">
                                    <label for="name">Nombre de la charter</label>
                                    <input name="name" class="form-control form-control-lg" type="text" placeholder="Escribe aqui el nombre de la charter" id="name" v-model="charter.name"  @click="alert.charter_errors.name = false">
                                </div>
                            </div>
                        </div>
                        <!-- charter_max_anglers -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group" :class="{ 'alert-red': alert.charter_errors.description }">
                                    ...
                                    <button type="submit" class="btn btn-info float-right mt-2 py-2 px-4" style="font-size:18px;font-weight:bolder" id="submitCharter" v-show="!editing_charter">Subir charter</button>
                                    <button type="submit" class="btn btn-edit float-right mt-2 py-2 px-4" style="font-size:18px;font-weight:bolder" id="editCharter" v-show="editing_charter">Editar charter</button>
                ...
                <div class="col-12 navbarSon2">
                    ...
                    <div class="collapse navbar-collapse-burguer not-show col-12" id="navbarSupportedContent42">
                        ...
                        <div id="navbarSon2" class="my-3">
                                ...
                                <div class="row">
                                    <div class="col-6 col-sm-4 mb-3 card" v-for="(charterImage, index) of charterImages" :key="index" v-show="!deletedCharterImg.includes(charterImage.id)">
                                        <img :src="$props.url+'/img/charters/gallery/'+charterImage.name" class="w-100"  >
                                        <button class="small btn btn-outline-danger p-1 mt-1" @click="deleteImgBoat(charterImage.id)">Eliminar</button>
                                    </div>
                                </div>
    ...
    export default {
        data: function(){
            return {
                ...
                captain:JSON.parse(this.$props.charter_captain),
                 rates:{
                    half_day:'',
                    duration_half_day:'',
        ...
        mounted() {
            ...
            $('#submitCharter').click((event) => {
                ...
                if (typeof files !== "undefined") {
                    ...
                    fd.append('_token', vm.$props.csrf_token);
                        ...
                        success: function(response) {
                            if (response.action == "success") {
                                ...
                                $.blockUI({
                                    message: '<p style="font-weight:bolder;font-size:3em;text-align:center;color:#ffffff;line-height:1;margin-bottom:.3rem">charter <span style="color:#7400b8">' + response.charter_name + '</span> creada!<br> ahora puedes seguir editando más propiedades de la charter<span style="color:#7400b8">...</span></p>',
                                    css: {
                                        width: '650px',
                                        border: 'none',
                                        padding: '15px',
                    ...
                    $.blockUI({
                        message: '<p style="font-weight:bolder;font-size:3em;text-align:center;color:#ffffff;line-height:1;margin-bottom:.3rem">Se necesita subir la imagen principal<br>de la charter!</p>',
                        css: {
                            width: '650px',
                            border: 'none',
                            padding: '15px',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.action == "success") {
                                vm.boat_features = true;
                                vm.charter.id = response.charter_id;
                                vm.charter.img = response.charter_img;
                                vm.editing_charter = true

                                $.blockUI({
                                    message: '<p style="font-weight:bolder;font-size:3em;text-align:center;color:#28a745;line-height:1;margin-bottom:.3rem">charter ' + response.charter_name + ' editada!</p>',
                                    css: {
                                        width: '650px',
                                        border: 'none',
                                        padding: '15px',
