                            ...
                            <div class="row">
                                ...
                                <div class="file-field">
                                    <div class="z-depth-1-half mb-4">
                                        ...
                                        alt="example placeholder" v-show="!charter.img_preview">

                                        <img :src="charter.img_preview" class="img-fluid"
                                        alt="example placeholder" v-show="charter.img_preview">
                                    </div>
                                    <div class="d-flex justify-content-center">
                                        <div class="btn btn-mdb-color btn-rounded" style="max-width:100%" :class="{ 'alert-red': alert.img_charter }">
                                            <span>Subir Imagen Principal de la lancha</span> <br>
                                            <input type="file" name="img" id="imgCharter" style="max-width:100%;overflow:hidden" v-on:change="previewFiles" @click="alert.img_charter = false">
                                        </div>
                                    </div>
                                </div>
                                </div>
        ...
        <!-- end container-fluid -->
            ...
            <nav class="navbar navbar-light cyan lighten-4 text-center row px-0">
                ...
                <div class="col-12 navbarSon4">
                    ...
                    <!-- Collapsible content charters/image_boats -->
                </div>
        ...
        mounted() {
            ...
            $('#editCaptain').click((event) =>  {
                ...
                if (typeof files !== "undefined"){
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'update-captain-info/'+charter_id,
                        dataType: 'json',
                        contentType: false,
                        processData: false,
                        data: fd,
