                            ...
                            <div class="file-field">
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="btn btn-mdb-color btn-rounded" :class="{ 'alert-red': alert.img_charter }" style="max-width:100%">
                                        ...
                                        <input type="file" name="img" id="imgPanga" style="max-width:100%;overflow:hidden!important" placeholder="Seleccionar Imagen" v-on:change="previewFiles" @click="alert.img_charter = false">
                                    </div>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group"  :class="{ 'alert-red': alert.charter_errors.name }">
                                    ...
                                    <input name="name" class="form-control form-control-lg" type="text" placeholder="Escribe aqui el nombre de la panga" id="name" v-model="charter.name"  @click="alert.charter_errors.name = false">
                                </div>
                            </div>
                        </div>
                        <!-- charter_max_anglers -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group" :class="{ 'alert-red': alert.charter_errors.description }">
                                    ...
                                    <button type="submit" class="btn btn-info float-right mt-2 py-2 px-4" style="font-size:18px;font-weight:bolder" id="submitCharter" v-show="!editing_charter">Subir Panga</button>
                                    <button type="submit" class="btn btn-edit float-right mt-2 py-2 px-4" style="font-size:18px;font-weight:bolder" id="editCharter" v-show="editing_charter">Editar Panga</button>
        ...
        mounted() {
                    ...
                    fd.append('_token', vm.$props.csrf_token);
                        ...
                        success: function(response) {
                            if (response.action == "success") {
                                ...
                                $.blockUI({
                                    message: '<p style="font-weight:bolder;font-size:3em;text-align:center;color:#ffffff;line-height:1;margin-bottom:.3rem">Panga <span style="color:#7400b8">' + response.charter_name + '</span> creada!<br> ahora puedes seguir editando más propiedades de la panga<span style="color:#7400b8">...</span></p>',
                                    css: {
                                        width: '650px',
                                        border: 'none',
                                        padding: '15px',
            ...
            $('#editCharter').click((event) => {
                ...
                var charter_id = vm.charter.id;
                    ...
                    $.ajax({
                        type: 'POST',
                        url:'/admin/edit-panga/' + charter_id,
                        dataType: 'json',
                        contentType: false,
                        processData: false,
                        data: fd,
                        success: function(response) {
                            if (response.action == "success") {
                                ...
                                $.blockUI({
                                    message: '<p style="font-weight:bolder;font-size:3em;text-align:center;color:#28a745;line-height:1;margin-bottom:.3rem">Panga ' + response.charter_name + ' editada!</p>',
                                    css: {
                                        width: '650px',
                                        border: 'none',
                                        padding: '15px',
            ...
            $('#editCaptain').click((event) =>  {
                ...
                if (typeof files !== "undefined"){
                    ...
                    $.ajax({
                        type: "POST",
                        url:'/admin/update-captain-info/'+charter_id,
                        dataType: 'json',
                        contentType: false,
                        processData: false,
                        data: fd,
