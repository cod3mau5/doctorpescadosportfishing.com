                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group" :class="{ 'alert-red': alert.charter_errors.description }">
                                    ...
                                    <button type="submit" class="btn btn-info float-right mt-2 py-2 px-4" style="font-size:18px;font-weight:bolder" id="submCharter" v-show="!editing_charter">Subir Lancha</button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            console.log('charter-rates-captain');
