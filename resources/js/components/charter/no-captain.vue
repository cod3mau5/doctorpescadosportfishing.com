                    ...
                    fd.append('_token', vm.$props.csrf_token);
                        ...
                        success: function(response) {
                            if (response.action == "success") {
                                ...
                                $.blockUI({
                                    message: '<p style="font-weight:bolder;font-size:3em;text-align:center;color:#ffffff;line-height:1;margin-bottom:.3rem">Charter <span style="color:#7400b8">' + response.charter_name + '</span> creada!<br> ahora puedes seguir editando más propiedades de la lancha<span style="color:#7400b8">...</span></p>',
                                    css: {
                                        width: '650px',
                                        border: 'none',
                                        padding: '15px',
