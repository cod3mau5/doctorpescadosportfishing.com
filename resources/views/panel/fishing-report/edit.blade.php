...
@endif
    <div class="container">
        <form method="POST" action="{{route('report.update',[$article->id])}}" enctype='multipart/form-data'>
            <div class="row">
                <div class="col-md-4 offset-md-4">
                 <div class="file-field">
                     <div class="z-depth-1-half mb-4">
                       <img src="{{url('uploads/'.$article->thumbnail_path.'/'.$article->thumbnail)}}" class="img-fluid"
                         alt="example placeholder" id="imageDisplayed">
                     </div>
            ...
            <div class="form-group">
                ...
                <input name="title" class="form-control form-control-lg" type="text" value="{{$article->title}}" id="title">
            </div>

            <div class="form-group">
                <label for="content">Contenido</label>
                <textarea name="content" class="form-control" id="textarea" rows="3">{!! $content !!}</textarea>
            </div>
        ...
        <script>
            $(document).on("change", "#imageUploader", function(e) {
                if(this.files[0].size > 91872749)
                {
                    ...
                    document.getElementById('imageDisplayed').src = 'https://mdbootstrap.com/img/Photos/Others/placeholder.jpg';
                }
            });
    </script>
@endsection