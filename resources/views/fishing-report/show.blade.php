...
@section('content')
    {{-- <div class="container">
        <div class="card">
            <img class="card-img-top" src="{{url('uploads/fullimg/'.$fishing_report_cabo->thumbnail_path.'/'.$fishing_report_cabo->thumbnail)}}" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">
                    {{$fishing_report_cabo->title}} <br>
                    <small>{{$fishing_report_cabo->date}}</small>
                </h5>
                <p>{{$fishing_report_cabo->content}}</p>
            </div>
        </div>
    </div> --}}
    ...
    {{-- <svg display="none" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="blog-container">
          ...
          <div class="blog-header">
            <div class="blog-cover" style="background:url({{url('uploads/fullimg/'.$fishing_report_cabo->thumbnail_path.'/'.$fishing_report_cabo->thumbnail)}})">
