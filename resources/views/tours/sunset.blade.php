    ...
    <div class="container-fluid">
        <div class="row py-3">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <img class="w-100" alt="Bootstrap Image Preview" src="{{asset('img/slider/tours/slide_2.jpg')}}" />
                    </div>
                    <div class="col-md-4">
                        <img class="w-100" alt="Bootstrap Image Preview" src="{{asset('img/slider/tours/slide_1.jpg')}}" />
                    </div>
                    <div class="col-md-4">
                        <img class="w-100" alt="Bootstrap Image Preview" src="{{asset('img/slider/tours/slide_4.jpg')}}" />
                    </div>
                </div>
                        ...
                        <div class="carousel slide" id="carousel-4384">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item">
                                    <img class="d-block w-100" alt="Carousel Bootstrap First" src="{{asset('img/slider/tours/slide_4.jpg')}}" />
                                    <div class="carousel-caption">
                                        <h4>
                                            Sunset at Arco San Lucas
                                        </h4>
                                        <p>
                                ...
                                <div class="carousel-item active">
                                    <img class="d-block w-100" alt="Carousel Bootstrap Second" src="{{asset('img/slider/tours/slide_2.jpg')}}" />
                                    <div class="carousel-caption">
                                        <h4>
                                            Sunset at Arco San Lucas
                                        </h4>
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" alt="Carousel Bootstrap Third" src="{{asset('img/slider/tours/slide_1.jpg')}}" />
                                    <div class="carousel-caption">
